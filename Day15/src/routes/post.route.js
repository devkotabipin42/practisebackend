...
const { getPostController,likePostDetailsController } = require('../controller/post.controller')
...
postRouter.post('/like/:postId',identifyUser,likePostDetailsController)
