...
async function getunLikeDetailsController(req,res){
  const postId= req.params.postId
  const username = req.user.username
...
module.exports={postCollection,getPostController,getPostDetailsController,getLikeDetailsController,postFeedController,getunLikeDetailsController}